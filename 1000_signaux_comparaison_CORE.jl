...
pdetect = calculate_pd(nt, sig1, t_carre_daGFSS, t_carre_voisin, ρ ,d ,v ,T1000)
retard = calculate_delay(nt, sig1, t_carre_daGFSS, t_carre_voisin, ρ ,d ,v ,T1000)

plot(t_carre_daGFSS_sc[100,init_sc:fin],xlabel="temps", ylabel="t_carre_aGFSS")
pfausse, tdetecttot = calculate_pfa(nt, t_carre_daGFSS_sc, ρ ,d ,v ,T1000)
...
pdetect2 = calculate_pd(nt, sig1, t_daGFSS_carre, t_voisin_carre, ρ ,d ,v ,T10002)
retard2 = calculate_delay(nt, sig1, t_daGFSS_carre, t_voisin_carre, ρ ,d ,v ,T10002)

plot(t_daGFSS_carre_sc[100,init_sc:fin],xlabel="temps", ylabel="t_daGFSS_carre")
pfausse2, tdetecttot2 = calculate_pfa(nt, t_daGFSS_carre_sc, ρ ,d ,v ,T10002)
...
pdetect3 = calculate_pd(nt, sig1, t_daGFSS, t_carre_diaGFSS, ρ ,d ,v ,T10003)
retard3 = calculate_delay(nt, sig1, t_daGFSS, t_carre_diaGFSS, ρ ,d ,v ,T10003)


plot(t_daGFSS_sc[100,init_sc:fin],xlabel="temps", ylabel="t_daGFSS")
pfausse3, tdetecttot3 = calculate_pfa(nt, t_daGFSS_sc, ρ ,d ,v ,T10003)
...
pdetect4 = calculate_pd(nt, sig1, sumtot_daGFSS, t_carre_diaGFSS, ρ ,d ,v ,T10004)
retard4 = calculate_delay(nt, sig1, sumtot_daGFSS, t_carre_diaGFSS, ρ ,d ,v ,T10004)


plot(sumtot_daGFSS_sc[100,init_sc:fin],xlabel="temps", ylabel="t_sum_daGFSS")
pfausse4, tdetecttot4= calculate_pfa(nt, sumtot_daGFSS_sc, ρ ,d ,v ,T10004)
